import{i as G,a as D,S as $,b as Q,N as ee,P as pe,K as te,A as be,R as fe,M as ge}from"./assets/vendor-BG3zRxPs.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const u of r.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&n(u)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const o={successList:document.querySelector(".success-list"),successBtnForward:document.querySelector(".success-button-forward"),successBtnBack:document.querySelector(".success-button-back"),successAnimation:document.querySelector(".ajax-loader"),successPagination:document.querySelector(".success-pagination"),ctgsList:document.querySelector(".pets-ctgs-list"),petsList:document.querySelector(".pets-list"),petsLoadBtn:document.querySelector(".pets-load-btn"),petsLoader:document.querySelector(".pets-loader"),petsPagination:document.querySelector(".pets-pagination"),faqListEl:document.querySelector("#faqList"),aboutSection:document.querySelector(".about"),aboutBtnForward:document.querySelector(".about-swiper-button-next"),aboutBtnBack:document.querySelector(".about-swiper-button-prev"),aboutSwiperWrapper:document.querySelector(".about-swiper-wrapper"),aboutPaginationElem:document.querySelector(".about .swiper-pagination"),header:document.querySelector(".header"),headerBurgerBtn:document.querySelector(".burger-btn"),headerMobileMenu:document.querySelector(".mobile-menu"),headerMobileLinks:document.querySelectorAll(".mobile-menu-nav-link, .mobile-menu-button"),headerBurgerTopLine:document.querySelector(".mobile-burger-menu-top-line"),headerBurgerMidLine:document.querySelector(".mobile-burger-menu-mid-line"),headerBurgerBotLine:document.querySelector(".mobile-burger-menu-bot-line")},se=e=>{e.key==="Escape"&&M()},he=()=>{o.headerBurgerTopLine.classList.toggle("top-line"),o.headerBurgerMidLine.classList.toggle("mid-line"),o.headerBurgerBotLine.classList.toggle("bot-line")},ve=()=>{o.headerBurgerTopLine.classList.remove("top-line"),o.headerBurgerMidLine.classList.remove("mid-line"),o.headerBurgerBotLine.classList.remove("bot-line")},ye=()=>{document.body.style.overflow="hidden",document.addEventListener("keydown",se),o.headerMobileMenu.classList.toggle("is-open"),o.headerMobileMenu.className!=="mobile-menu is-open"&&(document.body.style.overflow=""),he()},M=()=>{document.body.style.overflow="",o.headerMobileMenu.classList.remove("is-open"),document.removeEventListener("keydown",se),ve()},we=e=>{e.target.closest(".mobile-menu-btn, .mobile-menu-nav-link, .mobile-menu-button")||M()},Le=e=>{e.target.closest(".header-logo, .burger-btn")||M()};o.headerBurgerBtn.addEventListener("click",ye);o.header.addEventListener("click",Le);o.headerMobileMenu.addEventListener("click",we);o.headerMobileLinks.forEach(e=>{e.addEventListener("click",M)});window.addEventListener("resize",()=>{innerWidth>=1440&&(document.body.style.overflow="",o.headerMobileMenu.classList.remove("is-open"),M())});const j=document.querySelectorAll(".header-nav-link"),ke=document.querySelectorAll(".footer-nav-list a"),Se=document.querySelectorAll("section[id]");let z=null,q=!1;const H=()=>{j.forEach(e=>{e.classList.remove("is-active","is-inactive")}),z=null};window.addEventListener("scroll",()=>{window.scrollY===0&&(H(),q=!1)});const ae=e=>{H(),z=e,e.classList.add("is-active")},oe=e=>{q=!0;const s=e.getAttribute("href").slice(1),t=document.querySelector(`.header-nav-link[href="#${s}"]`);t&&(ae(t),j.forEach(i=>{i!==t&&i.classList.add("is-inactive")}));const n=document.getElementById(s);n&&n.scrollIntoView({behavior:"smooth"})};j.forEach(e=>{e.addEventListener("click",s=>{s.preventDefault(),oe(e)})});ke.forEach(e=>{e.addEventListener("click",s=>{s.preventDefault(),oe(e)})});const Ee=new IntersectionObserver(e=>{e.forEach(s=>{if(!s.isIntersecting)return;const t=s.target.id,n=document.querySelector(`.header-nav-link[href="#${t}"]`);if(!n){H(),q=!1;return}if(!q){ae(n);return}n===z&&(j.forEach(i=>i.classList.remove("is-inactive")),q=!1)})},{threshold:.3});Se.forEach(e=>Ee.observe(e));const p="/project-10/",ie=()=>window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop",ne=()=>B==="mobile"||B==="tablet"?8:9;let x,c=1,k,B=ie(),w=ne();const C=()=>B==="mobile",re=e=>G.error({title:"",message:`Помилка бекенду від "GoIt": 
    ${e}`,position:"topRight",iconUrl:`${p}public/error.svg`,messageColor:"#fafafb",messageSize:"16",titleWeight:"700",backgroundColor:"#ef4040",progressBarColor:"#b51b1b",timeout:3e3,maxWidth:432,theme:"dark",close:!0,class:"my-toast"});function F(){const e=Math.ceil(k/w);if(e<=1)return;let s="";if(s+=`<li>
  ...
  `}const $e=async e=>{const s=e.target.closest("button");if(!s)return;const t=Math.ceil(k/w);s.dataset.action==="prev"&&c>1&&(c-=1),s.dataset.action==="next"&&c<t&&(c+=1),s.dataset.page&&(c=+s.dataset.page);const n=o.petsList.getBoundingClientRect().top+window.pageYOffset-200;window.scrollTo({top:n,behavior:"smooth"}),V(),await P(c,x),F()};o.petsPagination.addEventListener("click",$e);const qe=async()=>await D("https://paw-hut.b.goit.study/api/categories"),xe=e=>{e.unshift({name:"Всі"});const s=["Всі","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];return e.sort((t,n)=>s.indexOf(t.name)-s.indexOf(n.name)),e.map(t=>`<li class="pets-ctgs-item"><button class="pets-ctgs-btn" aria-pressed="false" data-id="${t._id}" type="button">${t.name}</button></li>`).join("")},Be=async()=>{try{const e=await qe();o.ctgsList.innerHTML=xe(e.data);const s=document.querySelector(".pets-ctgs-btn");s.classList.add("active"),s.dataset.id="all",s.setAttribute("aria-pressed","true")}catch(e){re(e.message)}},Ce=async(e,s)=>{const t={page:e,limit:w};return s&&(t.categoryId=s),await D("https://paw-hut.b.goit.study/api/animals",{params:t})},K=e=>e.map(s=>`<li class="pets-item" role="listitem" data-id="${s._id}" data-description="${s.description||""}" data-health="${s.healthStatus||""}" data-behavior="${s.behavior||""}">
...
</li>`).join(""),P=async(e,s)=>{try{Ie();const t=await Ce(e,s);Xe(),C()?o.petsList.insertAdjacentHTML("beforeend",K(t.data.animals)):o.petsList.innerHTML=K(t.data.animals),k=t.data.totalItems,o.petsList.querySelectorAll(".pets-item").forEach((i,r)=>{const u=t.data.animals[r];u&&(i.dataset.description=u.description||"",i.dataset.health=u.healthStatus||"",i.dataset.behavior=u.behavior||"")})}catch(t){re(t.message)}},le=()=>o.petsList.innerHTML="",Me=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(t=>{t.classList.remove("active"),t.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},Pe=async e=>{e.target.nodeName==="BUTTON"&&(R(),V(),Me(e.target),x=e.target.dataset.id==="all"?void 0:e.target.dataset.id,c=1,le(),await P(c,x),C()&&k>w?_():C()||F())};o.ctgsList.addEventListener("click",Pe);const Ae=async()=>{c++,await P(c,x),c*w>=k&&R()};o.petsLoadBtn.addEventListener("click",Ae);const R=()=>{o.petsLoadBtn.style.display="none"},_=()=>{o.petsLoadBtn.style.display="block"},Xe=()=>{o.petsLoader.style.display="none"},Ie=()=>{o.petsLoader.style.display="block"},V=()=>{o.petsPagination.style.display="none"},Te=()=>{const e=ie();e!==B&&(le(),R(),V(),B=e,w=ne(),c=1,P(c,x),e==="mobile"&&c*w<k?_():e!=="mobile"&&F())};window.addEventListener("resize",Te);const Oe=async()=>{await Be(),await P(c),C()&&k>w?_():C()||F()};Oe();function De(){return`
    ...
    </div>`}function je(e){const s=De();document.body.insertAdjacentHTML("beforeend",s),document.body.classList.add("body-lock");const t=document.querySelector("[data-order-modal-backdrop]"),n=t.querySelector("[data-order-modal-close]"),i=t.querySelector("[data-order-modal-form]"),r=t.querySelector("#username"),u=/[^a-zA-Z\u0400-\u04FF\s'’`-]/g;function l(a){return a.replace(u,"").replace(/\s+/g," ").replace(/-+/g,"-").trim()}r.addEventListener("input",a=>{const m=a.target,v=m.value,f=m.selectionStart,E=l(v);if(E===v)return;m.value=E;const X=v.length-E.length,y=Math.max(0,f-X);m.setSelectionRange(y,y)}),r.addEventListener("paste",a=>{a.preventDefault();const m=(a.clipboardData||window.clipboardData).getData("text"),v=l(m),f=a.target,E=f.selectionStart,X=f.selectionEnd,y=f.value.slice(0,E),I=f.value.slice(X);f.value=l(y+v+I);const g=(y+v).length;f.setSelectionRange(g,g)}),r.addEventListener("blur",a=>{a.target.value=l(a.target.value)});const d=t.querySelector("#phone");d.addEventListener("focus",()=>{d.value.trim()===""&&(d.value="+38 (0")}),d.addEventListener("input",()=>{let a=d.value.replace(/\D/g,"");a.startsWith("380")||(a.startsWith("0")?a="380"+a.slice(1):a.startsWith("3")?a=a:a.length>0&&(a="380"+a));let m="+38 (0";a.length>3&&(m+=a.substring(3,5)),a.length>5&&(m+=") "+a.substring(5,8)),a.length>8&&(m+=" "+a.substring(8,10)),a.length>10&&(m+=" "+a.substring(10,12)),d.value=m});function S(a){return a.replace(/\D/g,"").slice(0,12)}const b=t.querySelector("#message"),A=t.querySelector("#comment-error"),me=t.querySelector("#comment-counter");function W(){const a=b.value.trim().length;me.textContent=`${a}/300`,a===0?(A.textContent="",b.classList.remove("invalid")):a<5?(A.textContent="Коментар має бути не менше 5 символів",b.classList.add("invalid")):a>300?(A.textContent="Коментар має бути не більше 300 символів",b.classList.add("invalid")):(A.textContent="",b.classList.remove("invalid"))}b.addEventListener("input",W),b.addEventListener("blur",W);const U=t.querySelectorAll(".order-modal-input, .order-modal-input-textarea");U.forEach(a=>{a.addEventListener("input",()=>{a.value=a.value.trim(),a.validity.valueMissing||a.validity.patternMismatch||a.validity.tooShort||a.validity.tooLong?a.classList.add("invalid"):a.classList.remove("invalid")}),a.addEventListener("blur",()=>{a.validity.valueMissing||a.validity.patternMismatch||a.validity.tooShort||a.validity.tooLong?a.classList.add("invalid"):a.classList.remove("invalid")})}),n.addEventListener("click",()=>T(t)),t.addEventListener("click",a=>{a.target===t&&T(t)}),window.addEventListener("keydown",a=>{a.key==="Escape"&&T(t)}),i.addEventListener("submit",async a=>{a.preventDefault(),U.forEach(g=>g.dispatchEvent(new Event("blur")));const m=l(r.value),v=(m.match(/[a-zA-Z\u0400-\u04FF]/g)||[]).length>=2;if(!m||!v){$.fire({icon:"warning",title:"Перевірте ім’я",text:"Ім’я має містити щонайменше 2 літери.",background:"var(--color-scheme-1-foreground)",confirmButtonColor:"var(--color-mariner-dark)"}),r.focus();return}const f=S(d.value);if(!/^380\d{9}$/.test(f)){$.fire({icon:"warning",title:"Перевірте телефон",text:"Формат телефону має бути 380XXXXXXXXX",background:"var(--color-scheme-1-foreground)",confirmButtonColor:"var(--color-mariner-dark)"}),d.focus();return}if(b.value.trim(),W(),b.classList.contains("invalid")){b.focus();return}if(!i.checkValidity()){$.fire({icon:"warning",title:"Перевірте форму",text:"Будь ласка, заповніть усі поля правильно.",background:"var(--color-scheme-1-foreground)",confirmButtonColor:"var(--color-mariner-dark)"});return}const y=(new FormData(i).get("message")||"").trim(),I={name:m,phone:f,animalId:e};y!==""&&(I.comment=y);try{const g=await fetch("https://paw-hut.b.goit.study/api/orders",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(I)}),N=await g.json().catch(()=>null);if(!g.ok)throw new Error((N==null?void 0:N.message)||"Помилка відправки заявки");$.fire({icon:"success",title:`Вітаємо, ${m}! Заявку надіслано!😻Ваш пухнастик буде скоро з вами.`,html:`
    <div class="dog-container">
      ...
      </div> `,background:"var(--color-scheme-1-foreground)",confirmButtonColor:"var(--color-mariner-dark)",showClass:{popup:"animate__animated animate__bounceIn"},hideClass:{popup:"animate__animated animate__fadeOutUp"}}),T(t)}catch(g){$.fire({icon:"error",title:"Помилка",text:g.message,background:"var(--color-scheme-1-foreground)",confirmButtonColor:"var(--color-mariner-dark)"})}})}function T(e){const s=e.querySelector("[data-order-modal-form]");s&&s.reset(),e.remove(),document.body.classList.remove("body-lock")}function Fe(e){return`
...
`;o.faqListEl.innerHTML=Re.map(Ve).join("");new be(".accordion-container",{duration:1e3,showMultiple:!1,collapse:!0,ariaEnabled:!0});const Ue=document.querySelector(".faq-ajax-loader"),J=20;for(let e=0;e<J;e++){const s=document.createElement("div");s.classList.add("paw"),s.style.animationDelay=`${(J-e)*.25+5}s`;const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.classList.add("icon");const n=document.createElementNS("http://www.w3.org/2000/svg","use");n.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#paw"),t.appendChild(n),s.appendChild(t),Ue.appendChild(s)}D.defaults.baseURL="https://paw-hut.b.goit.study";const Ke=async()=>(await D.get("/api/feedbacks",{params:{limit:25,page:18}})).data;document.addEventListener("DOMContentLoaded",Ye);async function Ye(){try{let u=function(l){t.forEach(b=>b.classList.remove("active","near","far")),t[l].classList.add("active"),t[l-1]&&t[l-1].classList.add("near"),t[l+1]&&t[l+1].classList.add("near"),t[l-2]&&t[l-2].classList.add("far"),t[l+2]&&t[l+2].classList.add("far");const d=r-i;let S=l-2;S=Math.max(0,Math.min(S,d)),o.successPagination.style.transform=`translateX(${-S*n}px)`};const e=await Ke();Je(e.feedbacks),document.querySelectorAll(".rating").forEach(l=>{const d=l.dataset.score;new fe(l,{score:d,number:5,readOnly:!0,half:!0,starType:"img",starOn:`${p}icons/filled.svg`,starOff:`${p}icons/outline.svg`,starHalf:`${p}icons/half.svg`}).init()});const s=new Q(".success-swiper",{modules:[ee,te,ge],speed:1e3,spaceBetween:32,slidesPerView:1,loop:!1,wrapperClass:"success-list",slideClass:"success-item",keyboard:{enabled:!0,onlyInViewport:!0},mousewheel:{enabled:!0},navigation:{nextEl:".success-button-forward",prevEl:".success-button-back",disabledClass:".success-btn-disabled"},breakpoints:{767:{slidesPerView:2}}}),t=[],n=16,i=6;let r=s.slides.length;for(let l=0;l<r;l++){const d=document.createElement("span");d.classList.add("success-bullet"),d.dataset.index=l,d.addEventListener("click",()=>{s.slideTo(l)}),o.successPagination.appendChild(d),t.push(d)}s.on("slideChange",()=>{u(s.activeIndex)}),u(0),s.on("slideChange",()=>{s.isEnd?o.successBtnForward.classList.add("success-btn-disabled"):o.successBtnForward.classList.remove("success-btn-disabled")}),s.on("slideChange",()=>{s.isBeginning?o.successBtnBack.classList.add("success-btn-disabled"):o.successBtnBack.classList.remove("success-btn-disabled")})}catch{G.error({title:"",message:"Шось воно не робе!",position:"topRight",iconUrl:`${p}public/error.svg`,messageColor:"#fafafb",messageSize:"16",titleWeight:"700",backgroundColor:"#ef4040",progressBarColor:"#b51b1b",timeout:3e3,maxWidth:432,theme:"dark",close:!0,class:"my-toast"})}}const Je=e=>{const s=e.map(t=>`<li class="swiper-slide success-item" role="group" aria-label="Історія">
        ...
        </li>`).join("");o.successList.innerHTML=s},Ze=o.successAnimation,Z=15;for(let e=0;e<Z;e++){const s=document.createElement("div");s.classList.add("paw"),s.style.animationDelay=`${(Z-e)*.25}s`;const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.classList.add("icon");const n=document.createElementNS("http://www.w3.org/2000/svg","use");n.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#paw"),t.appendChild(n),s.appendChild(t),Ze.appendChild(s)}
