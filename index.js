...
</li>`).join(""),P=async(e,s)=>{try{Te();const t=await Me(e,s);Xe(),C()?o.petsList.insertAdjacentHTML("beforeend",K(t.data.animals)):o.petsList.innerHTML=K(t.data.animals),k=t.data.totalItems,o.petsList.querySelectorAll(".pets-item").forEach((i,r)=>{const c=t.data.animals[r];c&&(i.dataset.description=c.description||"",i.dataset.health=c.healthStatus||"",i.dataset.behavior=c.behavior||"")})}catch(t){ie(t.message)}},ne=()=>o.petsList.innerHTML="",Pe=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(t=>{t.classList.remove("active"),t.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},Ae=async e=>{e.target.nodeName==="BUTTON"&&(R(),V(),Pe(e.target),x=e.target.dataset.id==="all"?void 0:e.target.dataset.id,d=1,ne(),await P(d,x),C()&&k>w?_():C()||N())};o.ctgsList.addEventListener("click",Ae);const Ie=async()=>{d++,await P(d,x),d*w>=k&&R()};o.petsLoadBtn.addEventListener("click",Ie);const R=()=>{o.petsLoadBtn.style.display="none"},_=()=>{o.petsLoadBtn.style.display="block"},Xe=()=>{o.petsLoader.style.display="none"},Te=()=>{o.petsLoader.style.display="block"},V=()=>{o.petsPagination.style.display="none"},Oe=()=>{const e=ae();e!==B&&(ne(),R(),V(),B=e,w=oe(),d=1,P(d,x),e==="mobile"&&d*w<k?_():e!=="mobile"&&N())};window.addEventListener("resize",Oe);const De=async()=>{await Ce(),await P(d),C()&&k>w?_():C()||N()};De();function je(){return`
...
`;o.faqListEl.innerHTML=_e.map(Ue).join("");new me(".accordion-container",{duration:1e3,showMultiple:!1,collapse:!0,ariaEnabled:!0});const Ke=document.querySelector(".faq-ajax-loader"),J=20;for(let e=0;e<J;e++){const s=document.createElement("div");s.classList.add("paw"),s.style.animationDelay=`${(J-e)*.25+5}s`;const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.classList.add("icon");const n=document.createElementNS("http://www.w3.org/2000/svg","use");n.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#paw1"),t.appendChild(n),s.appendChild(t),Ke.appendChild(s)}F.defaults.baseURL="https://paw-hut.b.goit.study";const Ye=async()=>(await F.get("/api/feedbacks",{params:{limit:25,page:18}})).data;document.addEventListener("DOMContentLoaded",Je);async function Je(){try{let c=function(l){t.forEach(b=>b.classList.remove("active","near","far")),t[l].classList.add("active"),t[l-1]&&t[l-1].classList.add("near"),t[l+1]&&t[l+1].classList.add("near"),t[l-2]&&t[l-2].classList.add("far"),t[l+2]&&t[l+2].classList.add("far");const u=r-i;let S=l-2;S=Math.max(0,Math.min(S,u)),o.successPagination.style.transform=`translateX(${-S*n}px)`};const e=await Ye();Ze(e.feedbacks),document.querySelectorAll(".rating").forEach(l=>{const u=l.dataset.score;new pe(l,{score:u,number:5,readOnly:!0,half:!0,starType:"img",starOn:`${p}icons/filled.svg`,starOff:`${p}icons/outline.svg`,starHalf:`${p}icons/half.svg`}).init()});const s=new Q(".success-swiper",{modules:[ee,te,be],speed:1e3,spaceBetween:32,slidesPerView:1,loop:!1,wrapperClass:"success-list",slideClass:"success-item",keyboard:{enabled:!0,onlyInViewport:!0},mousewheel:{enabled:!0},navigation:{nextEl:".success-button-forward",prevEl:".success-button-back",disabledClass:".success-btn-disabled"},breakpoints:{767:{slidesPerView:2}}}),t=[],n=16,i=6;let r=s.slides.length;for(let l=0;l<r;l++){const u=document.createElement("span");u.classList.add("success-bullet"),u.dataset.index=l,u.addEventListener("click",()=>{s.slideTo(l)}),o.successPagination.appendChild(u),t.push(u)}s.on("slideChange",()=>{c(s.activeIndex)}),c(0),s.on("slideChange",()=>{s.isEnd?o.successBtnForward.classList.add("success-btn-disabled"):o.successBtnForward.classList.remove("success-btn-disabled")}),s.on("slideChange",()=>{s.isBeginning?o.successBtnBack.classList.add("success-btn-disabled"):o.successBtnBack.classList.remove("success-btn-disabled")})}catch{G.error({title:"",message:"Шось воно не робе!",position:"topRight",iconUrl:`${p}public/error.svg`,messageColor:"#fafafb",messageSize:"16",titleWeight:"700",backgroundColor:"#ef4040",progressBarColor:"#b51b1b",timeout:3e3,maxWidth:432,theme:"dark",close:!0,class:"my-toast"})}}const Ze=e=>{const s=e.map(t=>`<li class="swiper-slide success-item" role="group" aria-label="Історія">
