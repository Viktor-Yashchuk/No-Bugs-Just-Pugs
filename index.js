import{i as K,a as C,S as F,N as V,P as U,K as Y,A as _}from"./assets/vendor-DAtLxqiX.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(i){if(i.ep)return;i.ep=!0;const a=s(i);fetch(i.href,a)}})();const l={ctgsList:document.querySelector(".pets-ctgs-list"),petsList:document.querySelector(".pets-list"),petsLoadBtn:document.querySelector(".pets-load-btn"),petsLoader:document.querySelector(".pets-loader"),petsPagination:document.querySelector(".pets-pagination")},G=document.querySelector(".burger-btn"),g=document.querySelector(".mobile-menu");document.querySelector(".mobile-menu-btn");document.querySelector(".mobile-menu-container");const J=document.querySelectorAll(".mobile-menu-nav-link, .mobile-menu-button"),B=document.querySelector(".mobile-burger-menu-top-line"),A=document.querySelector(".mobile-burger-menu-mid-line"),T=document.querySelector(".mobile-burger-menu-bot-line"),Q=document.querySelector(".header"),I=e=>{e.key==="Escape"&&y()},X=()=>{B.classList.toggle("top-line"),A.classList.toggle("mid-line"),T.classList.toggle("bot-line")},Z=()=>{B.classList.remove("top-line"),A.classList.remove("mid-line"),T.classList.remove("bot-line")},ee=()=>{document.body.style.overflow="hidden",document.addEventListener("keydown",I),g.classList.toggle("is-open"),g.className!=="mobile-menu is-open"&&(document.body.style.overflow=""),X()},y=()=>{document.body.style.overflow="",g.classList.remove("is-open"),document.removeEventListener("keydown",I),Z()},te=e=>{e.target.closest(".mobile-menu-btn, .mobile-menu-nav-link, .mobile-menu-button")||y()},se=e=>{e.target.closest(".header-logo, .burger-btn")||y()};G.addEventListener("click",ee);Q.addEventListener("click",se);g.addEventListener("click",te);J.forEach(e=>{e.addEventListener("click",y)});window.addEventListener("resize",()=>{innerWidth>=1440&&(document.body.style.overflow="",g.classList.remove("is-open"),y())});const O=()=>window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop",W=()=>h==="mobile"||h==="tablet"?8:9;let f,o=1,b,h=O(),p=W();const v=()=>h==="mobile",H=e=>K.show({message:`Error: ${e}`,position:"topRight",color:"red",close:!1});function k(){const e=Math.ceil(b/p);if(e<=1)return;let t="";if(t+=`<li>
    ...
    </li>`,o===1){for(let s=1;s<=Math.min(3,e);s++)t+=m(s);e>3&&(t+='<li class="dots">…</li>',t+=m(e))}else if(o===e){t+=m(1),e>3&&(t+='<li class="dots">…</li>');for(let s=e-2;s<=e;s++)s>1&&(t+=m(s))}else{t+=m(1),o>3&&(t+='<li class="dots">…</li>');for(let s=o-1;s<=o+1;s+=1)s>1&&s<e&&(t+=m(s));o<e-2&&(t+='<li class="dots">…</li>'),e>1&&(t+=m(e))}t+=`<li>
    ...
    </li>`,l.petsPagination.style.display="flex",l.petsPagination.innerHTML=t}function m(e){return`
    <li>
      <button
  ...
  `}const ie=async e=>{const t=e.target.closest("button");if(!t)return;const s=Math.ceil(b/p);t.dataset.action==="prev"&&o>1&&(o-=1),t.dataset.action==="next"&&o<s&&(o+=1),t.dataset.page&&(o=+t.dataset.page);const n=l.petsList.getBoundingClientRect().top+window.pageYOffset-200;window.scrollTo({top:n,behavior:"smooth"}),q(),await w(o,f),k()};l.petsPagination.addEventListener("click",ie);const oe=async()=>await C("https://paw-hut.b.goit.study/api/categories"),ae=e=>{e.unshift({name:"Всі"});const t=["Всі","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];return e.sort((s,n)=>t.indexOf(s.name)-t.indexOf(n.name)),e.map(s=>`<li class="pets-ctgs-item"><button class="pets-ctgs-btn" aria-pressed="false" data-id="${s._id}" type="button">${s.name}</button></li>`).join("")},ne=async()=>{try{const e=await oe();l.ctgsList.innerHTML=ae(e.data);const t=document.querySelector(".pets-ctgs-btn");t.classList.add("active"),t.dataset.id="all",t.setAttribute("aria-pressed","true")}catch(e){H(e.message)}},re=async(e,t)=>{const s={page:e,limit:p};return t&&(s.categoryId=t),await C("https://paw-hut.b.goit.study/api/animals",{params:s})},x=e=>e.map(t=>`<li class="pets-item" role="listitem">
...
</li>`).join(""),w=async(e,t)=>{try{pe();const s=await re(e,t);ue(),v()?l.petsList.insertAdjacentHTML("beforeend",x(s.data.animals)):l.petsList.innerHTML=x(s.data.animals),b=s.data.totalItems,l.petsList.querySelectorAll(".pets-item").forEach((i,a)=>{const r=s.data.animals[a];r&&(i.dataset.description=r.description||"",i.dataset.health=r.healthStatus||"",i.dataset.behavior=r.behavior||"")})}catch(s){H(s.message)}},j=()=>l.petsList.innerHTML="",le=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(s=>{s.classList.remove("active"),s.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},ce=async e=>{e.target.nodeName==="BUTTON"&&(E(),q(),le(e.target),f=e.target.dataset.id==="all"?void 0:e.target.dataset.id,o=1,j(),await w(o,f),v()&&b>p?$():v()||k())};l.ctgsList.addEventListener("click",ce);const de=async()=>{o++,await w(o,f),o*p>=b&&E()};l.petsLoadBtn.addEventListener("click",de);const E=()=>{l.petsLoadBtn.style.display="none"},$=()=>{l.petsLoadBtn.style.display="block"},ue=()=>{l.petsLoader.style.display="none"},pe=()=>{l.petsLoader.style.display="block"},q=()=>{l.petsPagination.style.display="none"},me=()=>{const e=O();e!==h&&(j(),E(),q(),h=e,p=W(),o=1,w(o,f),e==="mobile"&&o*p<b?$():e!=="mobile"&&k())};window.addEventListener("resize",me);const be=async()=>{await ne(),await w(o),v()&&b>p?$():v()||k()};be();const u="/project-10/";function ge(e){return`
    <div class="details-modal-backdrop" data-details-modal-backdrop>
      <div class="details-modal" role="dialog" aria-modal="true" aria-labelledby="details-modal-title" aria-describedby="details-modal-description">
        ...
        <use href="${u}sprite.svg#icon-close"></use></svg></button>
    ...
    </div>`}function N(e){const t=ge(e);document.body.insertAdjacentHTML("beforeend",t),window.innerWidth-document.documentElement.clientWidth,document.body.classList.add("body-lock");const s=document.querySelector("[data-details-modal-backdrop]"),n=s.querySelector("[data-details-modal-close]"),i=s.querySelector("[data-details-modal-adopt]");n.addEventListener("click",()=>S(s)),s.addEventListener("click",r=>{r.target===s&&S(s)});function a(r){r.key==="Escape"&&(S(s),window.removeEventListener("keydown",a))}window.addEventListener("keydown",a),i.addEventListener("click",()=>{S(s)})}function S(e){e.remove(),document.body.classList.remove("body-lock")}l.petsList.addEventListener("click",e=>{var i,a,r,c,L;const t=e.target.closest(".pets-modal-btn");if(!t)return;const s=t.closest(".pets-item"),n={image:((i=s.querySelector(".pets-img"))==null?void 0:i.src)||"",species:((a=s.querySelector(".pets-species"))==null?void 0:a.textContent)||"",name:((r=s.querySelector(".pets-name"))==null?void 0:r.textContent)||"",age:((c=s.querySelector(".pets-info p:nth-child(1)"))==null?void 0:c.textContent)||"",gender:((L=s.querySelector(".pets-info p:nth-child(2)"))==null?void 0:L.textContent)||"",description:s.dataset.description||"",health:s.dataset.health||"",behavior:s.dataset.behavior||""};N(n)});l.petsList.addEventListener("keydown",e=>{var s,n,i,a,r;const t=e.target.closest(".pets-modal-btn");if(t&&(e.key==="Enter"||e.key===" ")){e.preventDefault();const c=t.closest(".pets-item"),L={image:((s=c.querySelector(".pets-img"))==null?void 0:s.src)||"",species:((n=c.querySelector(".pets-species"))==null?void 0:n.textContent)||"",name:((i=c.querySelector(".pets-name"))==null?void 0:i.textContent)||"",age:((a=c.querySelector(".pets-info p:nth-child(1)"))==null?void 0:a.textContent)||"",gender:((r=c.querySelector(".pets-info p:nth-child(2)"))==null?void 0:r.textContent)||"",description:c.dataset.description||"",health:c.dataset.health||"",behavior:c.dataset.behavior||""};N(L)}});const P=document.querySelector(".about-swiper-button-next"),M=document.querySelector(".about-swiper-button-prev"),fe=[{id:1,description:"Все почалося у 2015 році з кількох небайдужих людей та одного врятованого собаки. Сьогодні ми — один з найбільших притулків у регіоні, але наша мета незмінна: дати другий шанс тим, кого зрадили."},{id:2,description:'Ми рятуємо, реабілітуємо та знаходимо люблячі родини для безпритульних тварин. Наша мета — не просто дати прихисток, а й забезпечити кожному "хвостику" щасливе та повноцінне життя в новій родині.'},{id:3,description:'"Хатинка Лапок" — це команда професійних ветеринарів, кінологів та десятків волонтерів, які щодня вкладають свою душу та час у турботу про наших підопічних. Ми працюємо 24/7, бо їхнє життя залежить від нас.'},{id:4,description:"Ми створили безпечний та комфортний простір. Кожна тварина отримує якісне харчування, своєчасну ветеринарну допомогу, проходить соціалізацію та гуляє на спеціально обладнаних майданчиках."},{id:5,description:"Ваша допомога — безцінна. Ви можете взяти тваринку додому, стати волонтером, допомогти фінансово або інформаційно. Кожен маленький внесок наближає нас до великої мети — світу без безпритульних тварин."}],he=fe.map(({id:e,description:t})=>`<div class="swiper-slide about-slide">
          <picture>
            <source
